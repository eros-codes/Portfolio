export function generateProjectSchema(projects) {
  return {
    ...
    "@type": "ItemList",
    "@id": "https://www.aboutarvin.ir/#projects",
    ...
    itemListElement: projects.map((project) => ({
      ...
      ...(project.imageAddress && {
        image: `https://www.aboutarvin.ir/${project.imageAddress}`
      }),
      url: project.pageUrl
        ? `https://www.aboutarvin.ir/${project.pageUrl}`
        : "https://www.aboutarvin.ir/#projects",
      ...
      author: {
        "@id": "https://www.aboutarvin.ir/#person"
      },
